        ...
        <div>
            ...
            >
                ...
                <Form.Item label="Ngày khởi chiếu">
                    <DatePicker format={'DD/MM/YYYY'} onChange={handleChangeDate} value={dayjs(state.ngayKhoiChieu)} />
                </Form.Item>
                ...
                <Form.Item label="Đánh Giá">
                    <InputNumber name='danhGia' onChange={handleChangeNumber} value={state.danhGia} min={1} max={10} />
                </Form.Item>
                ...
                <Form.Item label="Tác Vụ">
                    <button className='p-2' type='submit'>Cập nhật Phim</button>
                </Form.Item>
            </Form>
        </div>
